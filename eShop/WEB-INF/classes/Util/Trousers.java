	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if(searchResult.next()) {
				System.out.println("got in if block in trousers");
			...
			searchResult = myStmt.executeQuery("select p.idproduct, p.pname, p.description, p.price, p.image_source " +
					"from product as p, belongsto as b where (p.idproduct=b.idproduct_belongsto_FK) and (b.category_name_FK=\"Trousers\"); ");  // 3. Form the SQL Query
			
			pwriter.println("	<div class=\"product\">\r\n" + 
					"				<div class=\"container\">\r\n"+
					"<div class=\"page_title\"><b> CHECK OUT OUR TROUSERS! </br></div>");
